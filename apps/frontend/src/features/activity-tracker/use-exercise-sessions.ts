...
export function useExerciseSessions() {
    ...
    // --- 5. New Set --- TODO: rename to exercise perfomance
    const newSetMutation = useMutation({
        mutationFn: async (payload: { exerciseLog: OptimisticExerciseLog }) => {

            //FIX: last performance should be from use exercises
    ...
    // --- 6. Update Set ---
    //Fix this should update the cache from useexercises epeccifically the last performance of the exercise.
