...
export const TesterInvitationEmail = ({ invitationsCode, userName = "there" }: TesterInvitationEmailProps) => {

    const invitaionUrl = `${process.env.FRONT_URL}/signup?invite=true&code=${invitationsCode}`;
                    ...
                    <Container className="bg-white mx-auto my-8 p-8 rounded-lg shadow-md max-w-lg">
                        ...
                        <Section className="mt-6">
                            ...
                            <Section className="text-center my-8">
                                <Button href={invitaionUrl} className="bg-primary text-primary-foreground px-6 py-3 rounded-md font-medium text-lg">
                                    Accept Invitation & Sign Up
                                </Button>
                            </Section>
                            <Text className="text-gray-600 text-sm">
                                Or copy and paste this link: <br />
                                <a href={invitaionUrl} className="text-primary underline">{invitaionUrl}</a>
                            </Text>
                        </Section>
