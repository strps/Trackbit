...
const UserNav = ({ user, onLogout, onThemeToggle, isDarkMode = false }: UserNavProps) => {
  ...
  return (
    <DropdownMenu >
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem onClick={onLogout} className="text-red-600 dark:text-red-400 focus:text-red-600 focus:bg-red-50 dark:focus:bg-red-950/20">
