 ...
 * @returns 
 */
const IconSelector = ({ selected, onChange }: IconSelectorProps) => (
 ...
 * 
 * @param {string} selected - currently selected color id
 * @param {function} onChange - callback when a color is selected
 * @returns 
 */
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-sans p-4 md:p-8">
          ...
          `}>
                        ...
                        `}
                                            >
                                                <div className={`p-2 rounded-lg ${formData.type === type.id
                                                ...
                                                <div>
                                                    <div className={`font-bold ${formData.type === type.id
